...
if not exist packages\Alea.cuBase.Direct3D9\lib\net40\Alea.CUDA.Direct3D9.dll (
	.nuget\nuget.exe install Alea.cuBase.Direct3D9 -OutputDirectory packages -ExcludeVersion -Prerelease
)

rem if not exist packages\SharpDX.Direct3D9\lib\net40\SharpDX.Direct3D9.dll (
rem 	.nuget\nuget.exe install SharpDX.Direct3D9 -OutputDirectory packages -ExcludeVersion -Prerelease
rem )

rem if not exist packages\SharpDX.RawInput\lib\net40\SharpDX.RawInput.dll (
